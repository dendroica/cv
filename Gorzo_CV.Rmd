...
output: #(function (..., theme = "banking", latex_engine = "xelatex") {; theme <- match.arg(theme); template <- ("moderncv-mod.tex"); vitae:::set_entry_formats(vitae:::moderncv_cv_entries); vitae:::copy_supporting_files("moderncv"); vitae::cv_document(..., pandoc_vars = list(theme = theme), template = template, latex_engine = latex_engine, keep_tex = TRUE)})
  #vitae::moderncv:
   # theme: banking
    #keep_tex: TRUE
    #page_total: true
